...
if(isset($_POST['submit'])){
    ...
    if( !$error && !$name_error && !$email_error && !$password_error && !$email_check_error){
        ...
        $sql = "UPDATE user_info SET user_name = '$username', user_email = '$email', user_password = '$password' WHERE id = '$user_id'";
        $result = mysqli_query($conn,$sql);
        if($result){
                    ...
                    <div class="new-file">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="document-form">
                            <div>
                                ...
                                <input type="text" placeholder="Enter New Name" id="update_name" name="user_name" value="<?php echo $_SESSION['username'] ?>" />
                                    <?php if($name_error) { echo '<span class="error-box">'. $name_error.'</span>'; } ?>
                            </div>
                            <div>
                                <label for="update_email">Email</label>
                                <input type="text" placeholder="Enter New Email" id="update_email" name="user_email" value="<?php echo $_SESSION['email'] ?>"/>
                            ...
                            <div>
                                ...
                                <input type="password" placeholder="Enter New Password" id="update_password" name="user_password" />
